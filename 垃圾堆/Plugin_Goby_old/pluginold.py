...
from plugins.Plugin_Goby_old.gobyTypes import ScanModel, AssetSearchModel, GobyAsset, Options, OptionsAssetSearch, \
    Vulnerability, PluginInfo
from multiprocessing import Process
from plugins.Plugin_Goby_old.common import runScan, checkProgress, getStatisticsData, assetSearch, stopScan, dataStore
...
class Plugin_Goby(AbstractPlugin):
    ...
    def __init__(self, assets: list, settings: dict):
        ...
        self.pluginName = 'Plugin_Goby_old'
        self.processNum = 1
        self.threadNum = 1
...
# @PluginManager.pluginRunFunctionRegister('Plugin_Goby_old')
